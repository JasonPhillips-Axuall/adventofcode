...
class TestDay2(unittest.TestCase):
    ...
    def test_has_adjacent_symbol(self):
        self.assertTrue(has_symbol_between("...*......", 1, 3))
        
        # self.assertFalse(has_symbol_between("617*......", 7,9))
        # self.assertFalse(has_symbol_between(".....+.58.", 7,9))
        # self.assertFalse(has_symbol_between("..592.....", 7,9))

        # self.assertEqual(exec("467..114..\n...*......"), 467)
        # self.assertEqual(exec("...*......\n..35..633."), 35)
        # self.assertEqual(exec("......755.\n...$.*...."), 755)
        # self.assertEqual(exec(test_data), 4361)
